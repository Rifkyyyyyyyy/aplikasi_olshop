...
public class UserView extends JFrame {
    ...
    public UserView(ProductViewModel viewModel) {
        ...
        // Button Actions
        addButton.addActionListener(s -> openAddDialog());
        viewButton.addActionListener(s -> loadAllProducts());
        updateButton.addActionListener(s -> openUpdateDialog());
        deleteButton.addActionListener(s -> deleteSelectedProduct());
    ...
    private void openAddDialog() {
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            viewModel.addProduct(product)
                    .thenAccept(s -> JOptionPane.showMessageDialog(this, "Product added successfully!"))
                    .exceptionally(e -> {
